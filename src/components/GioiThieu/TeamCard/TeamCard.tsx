...
export default function TeamCard({ member }: TeamCardProps) {
  // Split position by newline for proper line breaks
  const positionLines = member.position.split("\n");
    ...
    <article className="team-card">
      <div className="team-card__inner">
        ...
        <div className="team-card__photo">
          <Image
            src={member.image}
            alt={`${member.name} - ${positionLines[positionLines.length - 1]}`}
        ...
        <div className="team-card__info">
          ...
          <div className="team-card__contact">
            <div className="team-card__contact-item">
              ...
              <Link href={`mailto:${member.email}`} className="team-card__link">
                {member.email}
              </Link>
            </div>
            <div className="team-card__contact-item">
              ...
              <Link href={`tel:${member.phone}`} className="team-card__link">
                {member.phone}
              </Link>
            </div>
          </div>
          ...
          <div className="team-card__social">
            ...
            <Link
              ...
              className="team-card__social-link"
              aria-label={`Twitter của ${member.name}`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
